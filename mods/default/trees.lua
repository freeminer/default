...
function default.can_grow(pos)
	...
	if core.find_node_near(pos, (8-5*core.get_humidity(pos)/100), {"group:tree"}) then
		return false
	end
...
if minetest.get_mapgen_setting("mg_name") == "v6" or minetest.get_mapgen_setting("mg_name") == "indev" then
