...
minetest.register_node("flowers:mushroom_red", {
	...
	walkable = false,
	buildable_to = true,
	groups = {mushroom = 1, snappy = 3, attached_node = 1, flammable = 1, dig_immediate = 3, drop_by_liquid = 1},
	sounds = default.node_sound_leaves_defaults(),
...
minetest.register_node("flowers:mushroom_brown", {
	...
	walkable = false,
	buildable_to = true,
	groups = {mushroom = 1, food_mushroom = 1, snappy = 3, attached_node = 1, flammable = 1, dig_immediate = 3, drop_by_liquid = 1},
	sounds = default.node_sound_leaves_defaults(),
