...
function stairs.register_stair_inner(subname, recipeitem, groups, images, description, sounds, melt)
	local stair_images = {}
	for i, image in ipairs(images) do
		if type(image) == "string" then
			stair_images[i] = {
...
function stairs.register_stair_outer(subname, recipeitem, groups, images, description, sounds, melt)
	local stair_images = {}
	for i, image in ipairs(images) do
		if type(image) == "string" then
			stair_images[i] = {
...
function stairs.register_stair_and_slab(subname, recipeitem, groups, images, desc_stair, desc_slab, sounds, melt)
	...
	stairs.register_stair_inner(subname, recipeitem, groups, images, desc_stair, sounds, melt)
	stairs.register_stair_outer(subname, recipeitem, groups, images, desc_stair, sounds, melt)
